# sapper-discord-supabase-tailwind-template

Template for quickstarting a [Sapper](https://github.com/sveltejs/sapper) project with Discord OAuth, Supabase and TailwindCSS. Uses Rollup as bundler. 
...
```bash
npx degit "msyyn/sapper-discord-supabase-tailwind" my-app
```
...
Set your database url and public anon key in `src/supabase.js`
You can find these in your Supabase project dashboard.

**Configuring Discord OAuth**
Set your Discord application's client ID, secret token and redirect URI in `src/discord.js`
You can generate all of those here: https://discord.com/developers/applications
Make sure to include protocol in your redirect URI, i.e. http://
